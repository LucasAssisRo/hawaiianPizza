...
class WideShopsTableRow: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func registerNibThis() {
        self.collectionView.register(WideCollectionViewItem.self,
                                     forCellWithReuseIdentifier: "WideCollectionViewItem")
        self.collectionView.register(UINib(nibName: "WideCollectionViewItem", bundle: nil),
                                     forCellWithReuseIdentifier: "WideCollectionViewItem")
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.cellImageView.image = #imageLiteral(resourceName: "2")
        cell.cellTitleLabel.text = "Title"
        cell.cellSubtitleLabel.text = "Subtitle"
