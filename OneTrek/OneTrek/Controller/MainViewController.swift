...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.addTextToStory(index: 4)
        self.addActionToStory(index: 7)
    ...
    var venues: [Venue?] = [
        Venue(venueId: "0",
              ...
              description: "Il Musicante is the perfect place where to find any kind of rare vinyl from pop to classic music, but of course this is just the place to be if you want to discover some Neapolitan traditional music pearls as Roberto De Simone original records and even some iconic Neapolitan movies.",
        ...
        Venue(venueId: "1",
              ...
              description: "In the late ninety century Luigi Grassi was a puppet maker, counting the Royal Court among his clients. One day a poor woman came to him bagging to repair the doll of her daughter, not knowing anyone else with the ability to do so. Surprised by the request he puzzled for a minute, then he accepted to fix the humble doll, succeeding.",
        ...
        Venue(venueId: "2",
              ...
              description: "In this incredible place you can watch the artisans at work in restoring ancient books, but also working on new refined paper product. In the Legatoria you will find elegant hand-made agendas, booklets and so much more. Everything carefully crafted and decorated.",
